...
namespace Task_Scheduler
{
    class DatabaseTables
    {
        ...
        public const string CalendarItemTableCreation = "CREATE TABLE " + CalendarItemTableName + "(Name TEXT, id INTEGER PRIMARY KEY AUTOINCREMENT, Type TEXT, Date TEXT, Time TEXT, Details text, Complete Bool, FilePaths TEXT, SubTasks TEXT, CategoryId int);";
